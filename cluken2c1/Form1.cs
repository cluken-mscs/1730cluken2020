...
namespace cluken2c1
{
    public partial class Form1 : Form
    {
        ...
        private void input1TextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                sbyte1TextBox.Text = "error"; sbyte1 = 0; }
            try
            {
            ...
            {
                short1TextBox.Text = "error"; short1 = 0; }
            try
            {
            ...
            {
                ushort1TextBox.Text = "error"; ushort1 = 0; }
            try
            {
            ...
            {
                uint1TextBox.Text = "error"; uint1 = 0; }
            try
            {
            ...
            {
                long1TextBox.Text = "error"; long1 = 0; }
            try
            {
            ...
            {
                ulong1TextBox.Text = "error"; ulong1 = 0; }
            try
            {
            ...
            {
                double1TextBox.Text = "error"; double1 = 0.0; }
            try
            {
            ...
            {
                decimal1TextBox.Text = "error"; decimal1 = 0m; }
        }
        ...
        private void input2TextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                sbyte2TextBox.Text = "error"; sbyte2 = 0; }
            try
            {
            ...
            {
                short2TextBox.Text = "error"; short2 = 0; }
            try
            {
            ...
            {
                ushort2TextBox.Text = "error"; ushort2 = 0; }
            try
            {
            ...
            {
                uint2TextBox.Text = "error"; uint2 = 0; }
            try
            {
            ...
            {
                long2TextBox.Text = "error"; long2 = 0; }
            try
            {
            ...
            {
                ulong2TextBox.Text = "error"; ulong2 = 0; }
            try
            {
            ...
            {
                double2TextBox.Text = "error"; double2 = 0.0; }
            try
            {
            ...
            {
                decimal2TextBox.Text = "error"; decimal2 = 0m; }
        }
        ...
        {   try {
            ...
            try
            {
                this.int3 = checked(this.int1 + this.int2);     //Note"checked" tests for overflow
