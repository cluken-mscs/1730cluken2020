<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="cluken2h1._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox9A" runat="server" Width="121px"></asp:TextBox>
                <asp:TextBox ID="TextBox9B" runat="server" Width="119px"></asp:TextBox>
                <asp:TextBox ID="TextBox9Result" runat="server" Enabled="False" Width="130px"></asp:TextBox>
            </div>
            <div class="form-group">
                10) DateA &gt; DateB:
                <asp:TextBox ID="TextBox10A" runat="server" Width="113px"></asp:TextBox>
                <asp:TextBox ID="TextBox10B" runat="server" Width="112px"></asp:TextBox>
                <asp:TextBox ID="TextBox10Result" runat="server" Enabled="False" Width="103px"></asp:TextBox>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox19" runat="server" Width="209px">111 1st St, Lake City, MN 55041</asp:TextBox>
                <asp:TextBox ID="TextBox19Result" runat="server"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Label ID="Label20Text" runat="server" Text="10) StringBuilder.Append: "></asp:Label>
                <asp:Label ID="Label20Result" runat="server"></asp:Label>
            </div>
        </div>
        <asp:Button ID="StringCalculationButton" runat="server" OnClick="StringCalculationButton_Click" Text="String Calculations" />
    </div>
