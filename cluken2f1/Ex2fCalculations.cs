    ...
    public class Ex2fCalculations
    {
        ...
        public static string Calc08(string inputA, string inputB)
        {
            ...
            if (inputA != "" && inputB != "")
                ...
                if (price * quantity < 50m)
                    shipping = price * quantity + 5;
                else
        ...
        public static string Calc09(string inputA, string inputB)
        {
            ...
            decimal priceB = 0m;
            {
                if (inputA != "" && inputB != "")
                {
                    priceA = Decimal.Parse(inputA);
                    priceB = Decimal.Parse(inputB);
                    if (priceB < priceA)
                        return rate.ToString("Invalid input");
                    else
                        rate = (priceB - priceA) * 0.10m;
        ...
        public static string Calc10(string inputA, string inputB)
        {
            ...
            { 
                ...
                if (inputA != "0" && inputB != "0")
                    {
                    numberA = Decimal.Parse(inputA);
                    numberB = Decimal.Parse(inputB);
                    if (numberA > numberB)
